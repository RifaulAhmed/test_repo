...
import image4 from './assets/multi1.png'
import image5 from './assets/multi2.png'
import image6 from './assets/multi3.png'
import image7 from './assets/multi4.png'
import image8 from './assets/multi5.png'
import image9 from './assets/multi6.png'
...
import burgir5 from './assets/multi.png'
...
const Product2 = () => {
    ...
    const Card = ({ heading }) => (
        <div className="bg-white flex flex-col shadow-lg rounded-lg p-6 text-center">
    ...
    return (
        <>
          <Helmet>
                ...
                <meta name="description" content="Bellway Infotech Offers Versatile Multi-Service Solutions Tailored to Meet Diverse Needs. Discover How We Can Enhance Your Business Operations Today." />
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">MULTI SERVICE</h1>
              ...
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Multi Service
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/564x/1d/28/7c/1d287c58077648764e6a94b69b321956.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/88/38/b3/8838b376731a36d7de0e9c2eece7ca2f.jpg'
                            alt="Bellway Grocery"
                        ...
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-1 md:mt-0 text-center md:text-left">
                            <h2 className="text-3xl font-bold text-left mt-3">Welcome to Bellway Infotech - Your Partner in Innovation and Excellence</h2>
                            <p className="mt-9 text-lg" style={{ textAlign: 'start' }}>Bellway Infotech recognizes that in today's fast-paced environment, organizations want adaptable and dependable solutions to be competitive. Our multi-service solutions are intended to meet a wide range of needs, ensuring that you have the necessary tools to improve your operations and achieve your objectives.
Custom software development involves creating software solutions that are tailored to your specific business needs.
Mobile Application Development: Create high-performance mobile apps for Android and iOS.
                        ...
                        <div className="mt-4 md:mt-0 text-center md:text-left mx-9">
                            ...
                            <div style={{ borderRadius: '60%'}} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-6">
                                {cardData.map((card, index) => (
                                    <div
                                        key={index}
                                        className="bg-[#212529] rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl "
                                    >
            ...
            <div className="flex flex-col items-center justify-center h-screen mt-24">
                <h2 className="text-4xl font-bold mb-8">Why Choose Bellway Multi Service?</h2>
