...
import image4 from './assets/Delicious1.png'
import image5 from './assets/Delicious2.png'
import image6 from './assets/Delicious3.png'
import image7 from './assets/Delicious4.png'
import image8 from './assets/Delicious5.png'
import image9 from './assets/Delicious6.png'
            ...
            {images.map((image, index) => (
                ...
                >
                    <img
                        ...
                        style={{ maxWidth: '100%', boxShadow: '0 0 20px rgba(0, 0, 0, 0.6)', borderRadius: '10%' }} // Added to maintain responsiveness
                    />
                </div>
            ))}
        </div>
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">DELICIOUS MEALS DELIVERY</h1>
              ...
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Delicious Meals Delivery
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/564x/13/d6/25/13d625df3f7e7e63cfa4bc6a3ec51e90.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/df/1e/72/df1e7243216a225a9b1a32ea6302abbd.jpg'
                            alt="Bellway Grocery"
                        ...
                        <div className="mt-4 md:mt-0 text-center md:text-left mx-9">
                            ...
                            <div style={{ borderRadius: '60%'}} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-6">
                                {cardData.map((card, index) => (
                                    <div
                                        key={index}
                                        className="bg-[#8F8841]  rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl text-nowrap "
                                    >
                ...
                <div className="flex flex-col items-center justify-center max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="col-span-1 flex items-center justify-center">
                            <img src={burgir5} alt="Center Image" style={{height:'32rem'}} />
                        </div>
                        <div className="col-span-1">
