...
import image4 from './assets/foodo1.png'
import image5 from './assets/foodo2.png'
import image6 from './assets/foodo3.png'
import image7 from './assets/foodo4.png'
import image8 from './assets/foodo5.png'
import image9 from './assets/foodo6.png'
...
import burgir5 from './assets/noodles.png'
...
const Product2 = () => {
    ...
    return (
        <>
         <Helmet>
                <title>Give The Best Service With Bellway Infotech's Fresh Delivery Apps</title>
                <meta name="description" content="Give the best service with Bellway Infotech fresh delivery apps. Enjoy seamless service, easy navigation, & quick deliveries for a hassle-free experience" />
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">FOODO</h1>
                
                        <a href="https://play.google.com/store/apps/details?id=com.foodo.customer"
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Foodo
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/736x/86/19/6a/86196a719c94e17763f55fe697f7e7dd.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/89/25/f2/8925f2d0b84465771785cdbc50f0720e.jpg'
                            alt="Foodo"
                        ...
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-1 md:mt-0 text-center md:text-left">
                            <h2 className="text-3xl font-bold text-left mt-3">Welcome to Bellway Infotech's application for food service.</h2>
                            <p className="mt-9 text-lg" style={{ textAlign: 'start' }}>

Bellway Infotech takes pride in offering high-quality digital solutions that meet the changing needs of both businesses and consumers. Our latest product, the Foodo application, demonstrates our dedication to excellence and innovation in the food service business.The Foodo app aims to transform the way you utilize food services. Whether you are a foodie, a busy professional, or a food service provider, our app aims to simplify and improve your interactions with food services.
                        ...
                        <div className="mt-4 md:mt-0 text-center md:text-left mx-9">
                            ...
                            <div style={{ borderRadius: '60%'}} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-6">
                                {cardData.map((card, index) => (
                                    <div
                                        key={index}
                                        className="bg-[#5AA469] rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl text-nowrap "
                                    >
            ...
            <div className="flex flex-col items-center justify-center h-screen mt-24">
                <h2 className="text-4xl font-bold mb-8">Why Choose Foodo?</h2>
