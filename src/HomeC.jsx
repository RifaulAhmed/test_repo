...
import image4 from './assets/home1.png'
import image5 from './assets/home2.png'
import image6 from './assets/home3.png'
import image7 from './assets/home4.png'
import image8 from './assets/home5.png'
import image9 from './assets/home6.png'
...
import burgir5 from './assets/realEstate.png'
    ...
    return (
        <>
           <Helmet>
                ...
                <meta name="description" content="Bellway Infotech offers the best website for house rentals, providing a seamless experience to find your ideal home. Explore our listings and find your perfect rental
" />
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">HOME-C</h1>
                
                        <a href="https://play.google.com/store/apps/details?id=com.home.c"
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Home-C
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/736x/3e/a3/b8/3ea3b872e571cf412ad34ef0c2b045ca.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/08/6f/d1/086fd1d2d89f7872d62ea95d04821be9.jpg'
                            alt="Foodo"
                        ...
                        <div className="mt-4 md:mt-0 text-center md:text-left mx-9">
                            ...
                            <div style={{ borderRadius: '60%' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-6">
                                {cardData.map((card, index) => (
                                    <div
                                        key={index}
                                        className="bg-[#387ADF] rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl "
                                    >
