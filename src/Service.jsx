...
const Service = () => {
  ...
  return (
    ...
    <div>
          ...
          <h1 className='nbs' style={{marginTop:'100px'}}>Web Application Devlopement</h1>
          <div className="card-container">
              ...
              <div>
                <div className='bi'>
                <button  onClick={handleClick} class="animated-button">Click Here</button>
                <button  onClick={handleClick1} class="animated-button1" style={{position:'relative',left:'-20px'}}>Click Here</button>
                <button  onClick={handleClick2} class="animated-button2" style={{position:'relative',left:'400px',top:'-70px'}}>Click Here</button>
                </div>
