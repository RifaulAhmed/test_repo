...
import image4 from './assets/bell1.png'
import image5 from './assets/bell2.png'
import image6 from './assets/bell3.png'
import image7 from './assets/bell4.png'
import image8 from './assets/bell5.png'
import image9 from './assets/bell6.png'
...
import burgir5 from './assets/store.png'
...
const Product2 = () => {
    ...
    return (
        <>
              <Helmet>
                <title>Effortless booking With BELLWAY INFOTECH Online Make Your Trip</title>
                <meta name="description" content="Effortless booking with Bellway Infotech online makes your trip service. Enjoy a seamless, user-friendly platform for all your travel planning and reservations." />
            </Helmet>
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">BELL STORE</h1>
                
                        <a href="https://play.google.com/store/apps/details?id=com.bellwayinfotech.bellstore_user"
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Bell Store
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/564x/ba/c5/69/bac569e7155c021f846e1def9d3793ce.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/14/2c/0a/142c0a0200a6bdb83e38406a814e9c80.jpg'
                            alt="Foodo"
                        ...
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-1 md:mt-0 text-center md:text-left">
                            <h2 className="text-3xl font-bold text-left mt-3">Effortless Shopping with online Bell Store</h2>
                            <p className="mt-9 text-lg" style={{ textAlign: 'start' }}>Say good-bye to the tiresome, traditional shopping trips and hello to the future with Bellway Infotech's Online Bell Store. Designed to provide you with a seamless and user-friendly shopping experience, our platform is perfect for all your grocery needs.

Learn How to Shop Without Stress
We at Bellway Infotech recognize how crucial convenience is to your hectic schedule. We designed our Online Bell Store to be a simple, effective way to shop so you can focus more of your time on the things that really count.
                        ...
                        <div className="mt-4 md:mt-0 text-center md:text-left mx-9">
                            ...
                            <div style={{ borderRadius: '60%' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12 p-6">
                                {cardData.map((card, index) => (
                                    <div
                                        key={index}
                                        className="bg-[#83B4FF] rounded-lg p-6 shadow-md transform transition duration-500 hover:scale-105 hover:shadow-2xl "
                                    >
            ...
            <div className="flex flex-col items-center justify-center h-screen mt-24">
                <h2 className="text-4xl font-bold mb-8">Why Choose Bell Store?</h2>
