            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">Make Your Trip</h1>
              ...
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / Make Your Trip
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/564x/ce/a7/b5/cea7b54b979ed42f69a894f9da5e2cc7.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            ...
                            alt="Foodo"
                            className="w-1/2 h-1/2 mt-5 md:w-1/2 h-1/2"
                        />
                        <div style={{ backgroundColor: 'white' }} className="md:ml-28 mt-3 md:mt-0 text-center md:text-left">
                            <h2 className="text-3xl font-bold text-left mt-3">Effortless Booking with Bellway Infotech Online: Make Your Trip</h2>
                            <p className="mt-9 text-lg" style={{ textAlign: 'start' }}>Planning and scheduling your next trip might be a bother, but with Bellway Infotech, it becomes a simple and pleasurable process. Bellway Infotech provides an intuitive, user-friendly platform built to meet all of your travel needs, providing a seamless and efficient booking experience.
Comprehensive travel options.

tickets: Locate and book tickets from a variety of airlines, ensuring the best prices and convenient timetables.
Hotels: Choose from a wide range of accommodations, from low-cost alternatives to luxury hotels.
Car Rentals: Rent a car with ease, allowing you to explore your destination at your own pace.
Vacation Packages: Discover carefully chosen vacation packages that include flights, hotels, and activities for a stress-free planning experience.
