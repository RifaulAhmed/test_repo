...
import image4 from './assets/hotel1.png'
import image5 from './assets/hotel2.png'
import image6 from './assets/hotel3.png'
import image7 from './assets/hotel4.png'
import image8 from './assets/hotel5.png'
import image9 from './assets/hotel6.png'
...
import burgir5 from './assets/go3.png'
            ...
            <div class="containerx mx-auto bg-black p-8">
                <div class="flex flex-col md:flex-row items-center">
                    <div class="md:w-1/2 text-left mb-4 md:mb-0 p-16">
                        <h1 class="text-5xl font-bold mb-4 text-white ">GO HOTEL</h1>
              ...
              target="_blank" class="relative inline-flex items-center justify-center p-5 px-6 py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-3 border-red-500 rounded-full shadow-md group mr-4">
                        ...
                        <h3 class="sm:text-2xl text-white mt-3">
                            <Link to="/" class="text-red-600 hover:underline">Home</Link> / GO Hotel
                        </h3>
                    </div>
                    <div class="md:w-1/2 text-right">
                        <img src='https://i.pinimg.com/564x/00/16/ae/0016ae4a066550e4e145c1ca74c8e6e0.jpg' alt="About Image" class="w-full h-auto" />
                    </div>
                </div>
            </div>
          ...
          Our AI Services"</h1> */}
                ...
                <div className="space-y-20 mt-12 mx-auto">
                    <div className="flex flex-col md:flex-row  text-black">
                        <img
                            src='https://i.pinimg.com/564x/15/ab/43/15ab436f3b70436502a80f52d3dad0d3.jpg'
                            alt="Foodo"
